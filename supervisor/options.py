...
class ServerOptions(Options):
    ...
    def _daemonize(self):
        ...
        if pid != 0:
            # Parent
            self.logger.info("supervisord forked; parent exiting")
            sys.exit(0)
            #os._exit(0)
        # Child
        if self.directory:
        ...
        os.setsid()
        os.umask(self.umask)
        self.logger.info("daemonizing the supervisord process success")
    ...
    def cleanup(self):
        self.logger.info('called clean up')
